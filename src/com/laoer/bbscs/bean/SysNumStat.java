...
public class SysNumStat implements Serializable {
    ...
    @Column(name = "RecDate", length = 20, nullable = false)
    private String recDate;

    @Column(name = "Num0", length = 11, nullable = false)
    private long num0;

    @Column(name = "NumInc0", length = 11, nullable = false)
    private long numInc0;

    @Column(name = "Num1", length = 11, nullable = false)
    private long num1;

    @Column(name = "NumInc1", length = 11, nullable = false)
    private long numInc1;

    @Column(name = "Num2", length = 11, nullable = false)
    private long num2;

    @Column(name = "NumInc2", length = 11, nullable = false)
    private long numInc2;

    @Column(name = "Num3", length = 11, nullable = false)
    private long num3;

    @Column(name = "NumInc3", length = 11, nullable = false)
    private long numInc3;

    @Column(name = "Num4", length = 11, nullable = false)
    private long num4;

    @Column(name = "NumInc4", length = 11, nullable = false)
    private long numInc4;

    @Column(name = "Num5", length = 11, nullable = false)
    private long num5;

    @Column(name = "NumInc5", length = 11, nullable = false)
