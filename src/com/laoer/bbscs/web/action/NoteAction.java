...
import com.laoer.bbscs.service.factory.NoteFactory;
...
public class NoteAction extends BaseMainAction implements RequestBasePathAware {
    ...
    public String addsave() {
        ...
        if (BBSCSUtil.getSysCharsetStrLength(this.getNoteTitle()) > 150) {
            this.getAjaxMessagesJson().setMessage(
                    "E_NOTE_TOOLONG",
                    this.getText("error.note.context.toolong", new String[]{"50"}));
            return RESULT_AJAXJSON;
        }
